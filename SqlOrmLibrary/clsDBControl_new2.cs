...
namespace SqlOrmLibrary
{
    ...
    /// </summary>
    internal class clsDBControl_new2
    {
        private OleDbConnection oConnect = null;
        private OleDbCommand oCommand = null;
        private OleDbTransaction oTransaction = null;

        public clsDBControl_new2(string sConectionInfo)
        {
        ...
        public clsDBControl_new2()
        {
        }

        public void SetDB(OleDbConnection iConnect, OleDbTransaction iTransaction)
        {
            oConnect = iConnect;
        ...
        public bool ExcuteNonQuerybyMapper(string sSql, dynamic obj, EntityMapper2 oEntity)
        {
            ...
            for (int i = 0; i < Properties.Length; i++)
            {
                ...
                if (oEntity.byte_type_members.Contains(sMemberName))
                {
                    ...
                    this.oCommand.Parameters.Add(table_field, OleDbType.Binary, inputByte.Length).Value = inputByte;
        ...
        //Batch 타입으로 입력
        public bool ExcuteNonQuerybyMapperList(List<string> sSql, dynamic obj, EntityMapper2 oEntity)
        {
        ...
        public bool ExcuteNonQuerybyMapperListWithSingleStatement(string sSql, dynamic obj, EntityMapper2 oEntity)
        {
