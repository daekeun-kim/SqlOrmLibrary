...
namespace SqlOrmLibrary
{
    internal class EntityMapper2
    {
        ...
        public DataTable LoadDatableRange(int StartValue, int EndValue)
        {
            ...
            string rear_paging_query = ")  QUERY";
            rear_paging_query += " WHERE ROWNUM <=(" + sEndValue + ")";
            rear_paging_query += ")";
            rear_paging_query += "WHERE RNUM>(" + sStartValue + ")";
        ...
        public DataTable LoadDatable(string input_sql, int NumofPage, int NumofDatas)
        {
            ...
            //paging query 완성
            sSql = front_paging_query + input_sql + rear_paging_query;
